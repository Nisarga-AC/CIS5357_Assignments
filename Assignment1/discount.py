...
print(f" The price of the Doll after 10% discount is $ {final1}")
discount2 = int(0.15 * Price)  # 15 percent is calculated
final2 = Price - discount2
print(f" The price of the Doll after 15% discount is ${final2}")
